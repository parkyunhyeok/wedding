...
var SEED = {
  ...
  transport_transit: "제주 시내버스 이용 시 '답다니' 정류장에서 하차 후 도보로 이동하실 수 있습니다. 정확한 노선과 소요 시간은 카카오맵·네이버지도의 대중교통 길찾기를 이용해 주세요.",
  transport_airport: "제주국제공항에서 예식장까지 차량으로 약 1시간~1시간 10분 정도 소요됩니다. [GATE 2]로 나오신 뒤 516방면으로 가는 정류장에서 181번 승차 — '국민연금공단 서귀포지사' 정류장 하차하시면 도보로 이동 가능합니다.",
  coverFileId: '',
  dataVersion: '1'
};
var SEED_ACCOUNTS = [
  { side: 'groom', label: '신랑', bank: '제주은행', holder: '박윤혁', number: '20-02-442167' },
  { side: 'groom', label: '신랑 부', bank: '농협', holder: '박경택', number: '979-02-316294' },
  { side: 'groom', label: '신랑 모', bank: '농협', holder: '우희란', number: '388-12-019785' }
];
